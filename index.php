...
<body>
  ...
  <section id="hero">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(assets/img/slide/child.png)">
  ...
  <main id="main">
    ...
    <section id="disasters" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Disasters</h2>
          <p>After a disaster, a community needs to rebuild and heal, and raiseHope offers many ways to help. Choose one of the disaster types, to see the available fundraising posts and make a donation.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox">
              ...
              <h4><a href="disaster.php?dt=1">Flood</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox">
              ...
              <h4><a href="disaster.php?dt=2">Fire</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox">
              ...
              <h4><a href="disaster.php?dt=3">Tornado</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox">
              ...
              <h4><a href="disaster.php?dt=4">Earthquake</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox">
              ...
              <h4><a href="disaster.php?dt=5">War</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox">
              ...
              <h4><a href="disaster.php?dt=6">Other</a></h4>
            </div>
          </div>
    ...
    <section id="about" class="about">
      <div class="container">
        <div class="section-title">
          <h2>Why Raise Hope</h2>
          <p>Raise Hope is a fundraising website dedicated to relieving natural and human-made disasters on a worldwide scale. Our determination to help and assist every community facing such disasters, ranks us among the top fundraising websites in the world. Some of our main traits are the following.</p>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 content-item">
              <span>01</span>
              <h4>Network Range</h4>
              <p>Over 300 disasters are relieved and over 3000 fundraising posts are successfully closed every year.</p>
            </div>

            <div class="col-lg-4 col-md-6 content-item">
              <span>02</span>
              <h4>Credibility</h4>
              <p>Fundraisers and posts are continously under review in order to filter fake content.</p>
            </div>

            <div class="col-lg-4 col-md-6 content-item">
              <span>03</span>
              <h4>Flexibility</h4>
              <p>Website designed to provide quick and easy ways of donating, both for mobile and web frameworks.</p>
            </div>
    ...
    <!-- <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="ass?succets/img/portfolio/portfolio-3.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>App 2</h4>
                <p>App</p>
                <div class="portfolio-links">
